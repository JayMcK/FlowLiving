...
export default function Footer({
  ...
  const socialMediaIcons = [
    { href: "https://www.facebook.com/", src: facebook, alt: "facebook link" },
    {
    ...
    { href: "https://www.tiktok.com/", src: tiktok, alt: "tiktok link" },
    { href: "https://twitter.com/", src: twitter, alt: "twitter link" },
  ];
      ...
      <Grid container direction="column">
        ...
        >
          ...
          <Grid item>
            ...
            >
              <img src={upArrow} alt="up arrow" className={classes.upArrow} />
            </Button>
          </Grid>
        </Grid>
